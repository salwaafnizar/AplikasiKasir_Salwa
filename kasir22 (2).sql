...
('DIDP001', '8992221088368', 5000, 5, 25000);
...
--
-- Dumping data for table `penjualasn`
--

INSERT INTO `penjualasn` (`PenjualanID`, `DetailID`, `TanggalPenjualan`, `JamPenjualan`, `TotalHarga`) VALUES
('IDP001', 'DIDP001', '2024-04-02', '10:28:49', 25000);
...
('8992221088368', 'buku', 5000, 40),
('8993988690047', 'penghapus', 2000, 50),
('8997017641826', 'parfum', 20000, 50);
...
--
ALTER TABLE `login`
  MODIFY `LoginID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
COMMIT;
